...
def parser(line):
    '''Encapsulates access to teh input code. Reads an assembly language
    command, parses it, and provides convenient access to teh command's
    components (fields and symbols). In addition, skips all white space and
    comments.'''
